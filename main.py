...
# spy_model = Model.Model(spy_env, name='SpyEnv', isNew=True, stop_threshold=1.1)
...
# agents_model = Model.Model(agents_env, name='AgentsEnv', isNew=True, stop_threshold=1.1)
